...
const FIELDS = [
  {
    ...
    label: [51.751567, -0.896724],
    hectares: 4.9,
    crop1979: ['Winter Wheat'],
    crop1980: ['Winter Wheat']
  },
  {
    id: 2,
    name: 'Lakes 2',
    ...
    label: [51.750982, -0.890342],
    hectares: 4.1,
    crop1979: ['Forage Peas/Oats'],
    crop1980: ['Winter Wheat']
  },
  {
    id: 3,
    ...
    label: [51.749458, -0.892197],
    hectares: 16.2,
    crop1979: ['Grove A: Winter Barley', 'Grove B: Winter Wheat'],
    crop1980: ['Grove A: Ley', 'Grove B: Winter Barley']
  },
  {
    id: 4,
    name: 'Fatting Ground',
    ...
    label: [51.749401, -0.887123],
    hectares: 2.8,
    crop1979: ['Permanent Pasture'],
    crop1980: ['Permanent Pasture']
  },
  {
    id: 5,
    name: 'The Slype',
  ...
  },
  {
    ...
    label: [51.747488, -0.887793],
    hectares: 4.4,
    crop1979: ['Maize'],
    crop1980: ['Forage Peas/Oats']
  },
  {
    id: 8,
    name: 'Big Banky',
  ...
  {
    id: 10,
    name: 'Bridge Field and Old Plough',
    color: '#fabebe',
    latlngs: [
      [51.746474, -0.888079],
      [51.744555, -0.883541],
  ...
  {
    id: 14,
    name: 'Great Ground, Pond and Mill Fields',
    color: '#fffac8',
    latlngs: [
      [51.749597, -0.89661],
      [51.747664, -0.897157],
  ...
  },
  {
    ...
    label: [51.749264, -0.90063],
    hectares: 14.7,
    crop1979: ['40 Acre E: Ley', '40 Acre M: Ley', '40 Acre W: Winter Wheat'],
    crop1980: ['40 Acre E: Ley', '40 Acre M: Forage Maize', '40 Acre W: Winter Wheat']
  },
  {
    id: 16,
    name: '5 Acres',
    ...
    label: [51.751467, -0.902598],
    hectares: 2.0,
    crop1979: ['Ley'],
    crop1980: ['Forage Maize']
  },
  {
    id: 17,
    name: 'Upper New Close',
    color: '#808000',
    latlngs: [
      [51.746296, -0.904324],
      [51.746224, -0.903733],
...
.leaflet-tooltip.ifm-field-tooltip { background: rgba(255,255,255,0.95); border: 1px solid rgba(0,0,0,0.15); border-radius: 4px; padding: 4px 6px; box-shadow: 0 1px 6px rgba(0,0,0,0.18); font-size: 13px; color: #111; }
.leaflet-tooltip.ifm-field-tooltip .ifm-tooltip-name { display: inline-block; font-size: 18px; font-weight: 700; line-height: 1.1; vertical-align: baseline; }
.leaflet-tooltip.ifm-field-tooltip .ifm-tooltip-field-label { display: inline-block; font-size: 12px; color: #555; line-height: 1.3; vertical-align: baseline; }
.leaflet-tooltip.ifm-field-tooltip .ifm-tooltip-area { font-size: 14px; font-weight: 700; line-height: 1; margin-right: 4px; vertical-align: baseline; margin-top: 8px;}
.leaflet-tooltip.ifm-field-tooltip .ifm-tooltip-year-label { font-size: 14px; color: #666; letter-spacing: 0.04em; margin-top: 8px; }
.leaflet-tooltip.ifm-field-tooltip .ifm-tooltip-crop { font-size: 12px; color: #111;}
...
const build = (container) => {
  ...
  for (const f of FIELDS) {
    ...
    poly.bindTooltip(
      `<span class="ifm-tooltip-name">${f.name}</span> (<span class="ifm-tooltip-field-label">${f.id}</span>)<br>` +
        `<div class="ifm-tooltip-area">${f.hectares} ha</div>` +
        `<div class="ifm-tooltip-year-label">1979 Crop</div>` +
        `${f.crop1979.map((item) => `<div class="ifm-tooltip-crop">${item}</div>`).join(``)}` +
        `<div class="ifm-tooltip-year-label">1980 Crop</div>` +
        `${f.crop1980.map((item) => `<div class="ifm-tooltip-crop">${item}</div>`).join(``)}`,
      { sticky: true, direction: 'top', offset: [0, -8], className: 'ifm-field-tooltip' }
    );
    ...
    li.innerHTML =
      `<span class="ifm-swatch" style="background:${f.color}"></span>` +
